...
export default function AdminAnnouncementCategoryModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingId) {
        await adminAxios.put(`/announcement-categories/${editingId}`, payload);
      } else {
        await adminAxios.post("/announcement-categories", payload);
      }
  ...
  const handleDelete = async (id) => {
    ...
    setIsLoading(true);
    try {
      await adminAxios.delete(`/announcement-categories/${id}`);
      await fetchCategories();
      if (onSuccess) onSuccess();
    } catch (error) {
