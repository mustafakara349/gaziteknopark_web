    ...
    <div className="space-y-6 max-w-[1400px] mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-[#0F172A] tracking-tight">
              Hizmet ve İmkanlarımız
            </h1>
          </div>
          <p className="text-gray-500 mt-2 text-sm max-w-xl">
            Gazi Teknopark bünyesinde sunulan hizmet, altyapı ve imkanların listesini buradan yönetebilirsiniz.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[1.5rem] border border-gray-100 shadow-sm p-12 text-center flex flex-col items-center justify-center min-h-[400px]">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-1">
          Hizmet ve İmkanlarımız Modülü
        </h3>
        <p className="text-gray-500 text-sm max-w-md">
          Bu sayfa varsayılan hizmet ve imkanlarımız yönetim ekranıdır. İçerikler eklendiğinde burada listelenecektir.
        </p>
      </div>
    </div>
  );
